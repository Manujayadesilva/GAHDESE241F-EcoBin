...
#define FIRESTORE_URL "https://firestore.googleapis.com/v1/projects/" FIRESTORE_PROJECT_ID "/databases/(default)/documents/bins/bin4/history"
...
// Bin Details
const float lat = 6.012662;  
const float lng = 80.24829; 
